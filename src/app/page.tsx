...
body { background:#0A0E1A; color:#EDF2F7; font-family:-apple-system,'Inter',sans-serif; line-height:1; }
...
.logo-img { width:52px; height:52px; object-fit:contain; border-radius:50%; display:block; filter:drop-shadow(0 0 8px rgba(0,200,232,0.25)); transition:filter .2s ease; }
.nav-logo:hover .logo-img { filter:drop-shadow(0 0 14px rgba(0,200,232,0.45)); }
.logo-wordmark { font-weight:800; font-size:1.25rem; letter-spacing:.04em; line-height:1; display:flex; align-items:center; }
.logo-codigo { color:#00C8E8; }
.logo-dash { color:#5A7090; margin:0 1px; }
.logo-base { color:#FF7A00; }
@media (max-width:480px) { .logo-wordmark { display:none; } .logo-img { width:44px; height:44px; } }
.nav-links { display:flex; gap:28px; }
.nav-links a { font-size:13px; color:#7A8BA8; text-decoration:none; transition:color .15s; }
.nav-links a:hover { color:#EDF2F7; }
.hdr-cta {
  display:flex; align-items:center; gap:8px;
  background:linear-gradient(135deg,#FF7A00,#E06800);
  padding:9px 20px; border-radius:100px;
  font-size:12px; font-weight:700; color:#fff;
  box-shadow:0 4px 20px rgba(255,122,0,.32); cursor:pointer; text-decoration:none;
}
...
.hero {
  ...
  background:
    radial-gradient(ellipse at 0% 50%, rgba(0,200,232,.10) 0%, transparent 48%),
    radial-gradient(ellipse at 90% 10%, rgba(255,122,0,.14) 0%, transparent 42%),
    radial-gradient(ellipse at 75% 90%, rgba(0,200,232,.07) 0%, transparent 38%);
}
.hero::after {
...
.badge {
  ...
  font-size:11px; color:#00C8E8; font-weight:600; margin-bottom:28px;
  letter-spacing:.2px;
}
.badge-dot { width:6px; height:6px; border-radius:50%; background:#00C8E8; box-shadow:0 0 8px rgba(0,200,232,.9); }

/* Headline */
.h1 { font-size:52px; font-weight:900; line-height:1.05; letter-spacing:-2.5px; color:#EDF2F7; margin-bottom:20px; }
.h1 .line2 { display:block; background:linear-gradient(90deg,#00C8E8 0%,#FF7A00 100%); -webkit-background-clip:text; -webkit-text-fill-color:transparent; }

/* Sub */
.sub { font-size:16px; color:#7A8BA8; line-height:1.7; max-width:440px; margin-bottom:32px; }
.sub strong { color:#EDF2F7; font-weight:600; }
...
.btn-a {
  ...
  box-shadow:0 6px 28px rgba(255,122,0,.38); cursor:pointer; text-decoration:none;
}
.btn-b {
  border:1px solid rgba(237,242,247,.12);
  padding:14px 26px; border-radius:100px;
  font-size:14px; color:#7A8BA8; cursor:pointer; text-decoration:none;
}
.microcopy { font-size:11px; color:#3D5068; display:flex; align-items:center; gap:6px; }
.microcopy::before { content:'✓'; color:#00C8E8; font-size:11px; }

/* Stats inline */
.stats { display:flex; gap:36px; padding-top:32px; border-top:1px solid rgba(237,242,247,.06); }
.stat-v { font-size:30px; font-weight:900; letter-spacing:-1px; }
.stat-l { font-size:11px; color:#7A8BA8; margin-top:4px; line-height:1.4; }
...
.fc {
  ...
  box-shadow:0 24px 64px rgba(0,0,0,.55), 0 1px 0 rgba(237,242,247,.06) inset;
}
.fc1 { top:0; left:0; width:210px; border:1px solid rgba(0,200,232,.18); }
.fc2 { top:130px; right:0; width:200px; border:1px solid rgba(255,122,0,.2); }
.fc3 { bottom:30px; left:24px; width:230px; border:1px solid rgba(0,200,232,.14); }
.fc4 { top:10px; right:16px; width:130px; border:1px solid rgba(237,242,247,.07); background:rgba(0,200,232,.05); }

.fc-tag { font-size:9px; color:#7A8BA8; margin-bottom:10px; text-transform:uppercase; letter-spacing:.8px; }
.fc-name { font-size:12px; font-weight:700; color:#EDF2F7; margin-bottom:10px; }
.fc-bar { height:4px; border-radius:2px; background:rgba(237,242,247,.06); margin-bottom:5px; overflow:hidden; }
.fc-bar-fill { height:100%; border-radius:2px; }
.fc-metric { font-size:22px; font-weight:900; letter-spacing:-1px; margin-top:8px; }
.fc-desc { font-size:10px; color:#7A8BA8; margin-top:3px; }
.bubble { font-size:11px; border-radius:8px; padding:7px 10px; margin-bottom:5px; line-height:1.4; }
.bubble.in { background:rgba(0,200,232,.1); color:#e0f2f7; }
.bubble.out { background:rgba(255,122,0,.1); color:#fed7aa; text-align:right; }
...
.stats-bar {
  ...
  background:rgba(237,242,247,.02);
  border-top:1px solid rgba(237,242,247,.05);
  border-bottom:1px solid rgba(237,242,247,.05);
}
.stat-item {
  padding:32px 28px; text-align:center;
  border-right:1px solid rgba(237,242,247,.04);
  position:relative;
}
.stat-item:last-child { border-right:none; }
.stat-big { font-size:36px; font-weight:900; letter-spacing:-1.5px; margin-bottom:6px; }
.stat-small { font-size:12px; color:#7A8BA8; line-height:1.5; }
.stat-context { font-size:10px; color:#3D5068; margin-top:4px; }
...
.sec-tag {
  ...
  font-size:10px; font-weight:700; color:#00C8E8;
  letter-spacing:1.5px; text-transform:uppercase; margin-bottom:14px;
}
.sec-tag::before { content:''; width:20px; height:1px; background:#00C8E8; }
.sec-h2 { font-size:42px; font-weight:900; letter-spacing:-2px; line-height:1.06; margin-bottom:14px; }
.sec-sub { font-size:15px; color:#7A8BA8; max-width:500px; line-height:1.65; }

.svc-grid { display:grid; grid-template-columns:repeat(3,1fr); gap:2px; }
.svc-card {
  padding:32px 28px; background:rgba(237,242,247,.025);
  border:1px solid rgba(237,242,247,.06);
  border-radius:2px; position:relative; overflow:hidden;
  transition:all .25s;
}
.svc-card:first-child { border-radius:20px 2px 2px 2px; }
.svc-card:last-child { border-radius:2px 2px 20px 2px; }
.svc-card:nth-child(2) { border-color:rgba(255,122,0,.15); background:rgba(255,122,0,.02); }
.svc-card:hover { background:rgba(0,200,232,.04); border-color:rgba(0,200,232,.25); }

.svc-icon { font-size:28px; margin-bottom:16px; }
.svc-problem { font-size:10px; font-weight:700; color:#FF7A00; letter-spacing:1px; text-transform:uppercase; margin-bottom:10px; }
.svc-h3 { font-size:20px; font-weight:800; letter-spacing:-.5px; margin-bottom:10px; }
.svc-desc { font-size:13px; color:#7A8BA8; line-height:1.65; margin-bottom:16px; }
.svc-transform { font-size:12px; color:#00C8E8; font-weight:600; padding:8px 12px; background:rgba(0,200,232,.07); border-radius:8px; border-left:2px solid #00C8E8; margin-bottom:16px; }
.svc-tags { display:flex; flex-wrap:wrap; gap:6px; }
.svc-tag { font-size:10px; padding:3px 10px; border-radius:100px; background:rgba(237,242,247,.05); color:#7A8BA8; }

/* ═══ COMO FUNCIONA ═══ */
.how {
  padding:88px 40px;
  background:radial-gradient(ellipse at 50% -5%, rgba(0,200,232,.06) 0%, transparent 55%);
}
...
.how-grid::before {
  ...
  height:1px;
  background:linear-gradient(90deg, rgba(0,200,232,.4) 0%, rgba(255,122,0,.4) 50%, rgba(0,200,232,.4) 100%);
}
...
.step-num {
  ...
  background:linear-gradient(135deg,rgba(0,200,232,.1),rgba(0,200,232,.03));
  color:#00C8E8;
}
.step:nth-child(2) .step-num { border-color:rgba(255,122,0,.3); background:linear-gradient(135deg,rgba(255,122,0,.1),rgba(255,122,0,.03)); color:#FF7A00; }
.step-h3 { font-size:18px; font-weight:800; text-align:center; margin-bottom:10px; letter-spacing:-.3px; }
.step-desc { font-size:13px; color:#7A8BA8; line-height:1.65; text-align:center; }
.step-note { font-size:11px; color:#3D5068; text-align:center; margin-top:10px; font-style:italic; }
...
.proj-card {
  ...
  border:1px solid rgba(237,242,247,.07);
  background:rgba(237,242,247,.02);
...
.proj-title-sm { font-size:15px; font-weight:800; color:#EDF2F7; letter-spacing:-.3px; }
...
.proj-context { font-size:12px; color:#7A8BA8; margin-bottom:10px; line-height:1.5; }
.proj-solution { font-size:12px; color:#7A8BA8; margin-bottom:12px; line-height:1.5; }
.proj-result {
  margin-top:auto; padding:10px 14px; border-radius:10px;
  display:flex; align-items:center; justify-content:space-between;
}
.proj-result-num { font-size:18px; font-weight:900; }
.proj-result-desc { font-size:10px; color:#7A8BA8; }

/* ═══ DEPOIMENTOS ═══ */
.testimonials { padding:88px 40px; background:rgba(255,255,255,.015); border-top:1px solid rgba(237,242,247,.04); }
.test-grid { display:grid; grid-template-columns:repeat(3,1fr); gap:20px; margin-top:60px; }
.test-card {
  border-radius:20px; padding:28px;
  border:1px solid rgba(237,242,247,.07);
  background:rgba(237,242,247,.025);
...
.test-avatar {
  ...
  background:rgba(0,200,232,.1); border:1px solid rgba(0,200,232,.2);
}
.avatar-initials {
  width:44px;
  height:44px;
  border-radius:50%;
  background:var(--color-primary, #00C8E8);
  display:flex;
  align-items:center;
...
.test-role { font-size:11px; color:#7A8BA8; }
.test-rating { font-size:12px; color:#FF7A00; }
.test-quote { font-size:13px; color:#7A8BA8; line-height:1.7; flex:1; font-style:italic; margin-bottom:16px; }
.test-project { font-size:10px; color:#3D5068; padding-top:12px; border-top:1px solid rgba(237,242,247,.05); display:flex; align-items:center; gap:6px; }
...
.cta-final::before {
  ...
  background:radial-gradient(ellipse at 50% 0%, rgba(255,122,0,.12) 0%, transparent 60%),
              radial-gradient(ellipse at 50% 100%, rgba(0,200,232,.08) 0%, transparent 55%);
}
.cta-final-tag { position:relative; font-size:10px; font-weight:700; color:#FF7A00; letter-spacing:2px; text-transform:uppercase; margin-bottom:20px; }
.cta-final-h2 { font-size:48px; font-weight:900; letter-spacing:-2.5px; line-height:1.06; margin-bottom:16px; position:relative; }
.cta-final-sub { font-size:16px; color:#7A8BA8; max-width:500px; margin:0 auto 12px; line-height:1.65; position:relative; }
.cta-final-note { font-size:12px; color:#3D5068; margin-bottom:36px; position:relative; }
.cta-final-note span { color:#00C8E8; }
...
.cta-trust-item { font-size:11px; color:#3D5068; display:flex; align-items:center; gap:5px; }
.cta-trust-item::before { content:'✓'; color:#00C8E8; }

/* ═══ FOOTER ═══ */
.footer {
  padding:60px 40px 28px; background:#0A0E1A;
  border-top:1px solid rgba(237,242,247,.05);
}
.footer-grid { display:grid; grid-template-columns:2.2fr 1fr 1fr 1.4fr; gap:40px; margin-bottom:44px; }
.f-logo { display:flex; align-items:center; gap:.625rem; margin-bottom:12px; }
.f-logo img { width:44px; height:44px; object-fit:contain; border-radius:50%; display:block; filter:drop-shadow(0 0 8px rgba(0,200,232,0.25)); }
.f-logo .logo-wordmark { font-size:1.1rem; }
.f-desc { font-size:13px; color:#7A8BA8; line-height:1.65; max-width:220px; margin-bottom:20px; }
.f-social { display:flex; gap:12px; }
.f-social-link { width:32px; height:32px; border-radius:8px; background:rgba(237,242,247,.04); border:1px solid rgba(237,242,247,.07); display:flex; align-items:center; justify-content:center; font-size:14px; color:#7A8BA8; text-decoration:none; transition:color .15s,border-color .15s; }
.f-social-link:hover { color:#00C8E8; border-color:rgba(0,200,232,.25); }
.f-col h5 { font-size:11px; font-weight:700; color:#EDF2F7; margin-bottom:16px; letter-spacing:.5px; text-transform:uppercase; }
.f-col a { display:block; font-size:13px; color:#7A8BA8; margin-bottom:10px; text-decoration:none; transition:color .15s; }
.f-col a:hover { color:#00C8E8; }
.f-contact-item { display:flex; align-items:center; gap:8px; font-size:13px; color:#7A8BA8; margin-bottom:10px; }
.f-contact-icon { width:28px; height:28px; border-radius:8px; background:rgba(0,200,232,.08); border:1px solid rgba(0,200,232,.15); display:flex; align-items:center; justify-content:center; font-size:12px; flex-shrink:0; }
.footer-bottom { display:flex; justify-content:space-between; align-items:center; padding-top:20px; border-top:1px solid rgba(237,242,247,.04); }
.footer-bottom p { font-size:12px; color:#3D5068; }
.footer-bottom-links { display:flex; gap:20px; }
.footer-bottom-links a { font-size:12px; color:#3D5068; text-decoration:none; }
`;
...
<section class="hero">
  <div class="hero-text">
    ...
    <div class="stats">
      <div>
        <div class="stat-v" style="color:#00C8E8;">24h</div>
        <div class="stat-l">Tempo médio<br/>de resposta</div>
      </div>
      <div>
        <div class="stat-v" style="color:#FF7A00;">2 em 1</div>
        <div class="stat-l">Software +<br/>Infraestrutura</div>
      </div>
      <div>
        <div class="stat-v" style="color:#00C8E8;">100%</div>
  ...
  <div class="hero-cards">
    ...
    <div class="fc fc1">
      ...
      <div class="fc-bar"><div class="fc-bar-fill" style="width:82%;background:linear-gradient(90deg,#00C8E8,#0088CC);"></div></div>
      <div class="fc-bar"><div class="fc-bar-fill" style="width:67%;background:linear-gradient(90deg,#FF7A00,#E06800);"></div></div>
      <div style="display:flex;justify-content:space-between;margin-top:10px;">
        <div>
          <div class="fc-metric" style="color:#00C8E8;">+38%</div>
    ...
    <div class="fc fc2">
      ...
      <div style="font-size:10px;color:#FF7A00;margin-top:6px;font-weight:600;">↓ 70% no tempo de resposta</div>
    </div>
    ...
    <div class="fc fc3">
      ...
      <div style="display:flex;gap:10px;margin-top:8px;">
        <div style="flex:1;text-align:center;background:rgba(0,200,232,.07);border-radius:10px;padding:10px;">
          <div style="font-size:17px;font-weight:900;color:#00C8E8;">-2°C</div>
          <div style="font-size:9px;color:#7A8BA8;">Câmara A</div>
        </div>
        <div style="flex:1;text-align:center;background:rgba(255,122,0,.07);border-radius:10px;padding:10px;">
          <div style="font-size:17px;font-weight:900;color:#FF7A00;">32</div>
          <div style="font-size:9px;color:#7A8BA8;">Sensores</div>
        </div>
        <div style="flex:1;text-align:center;background:rgba(34,197,94,.07);border-radius:10px;padding:10px;">
          ...
          <div style="font-size:9px;color:#7A8BA8;">Alertas</div>
        </div>
      </div>
    </div>
  </div>
...
<div class="stats-bar">
  <div class="stat-item">
    <div class="stat-big" style="background:linear-gradient(135deg,#00C8E8,#0088CC);-webkit-background-clip:text;-webkit-text-fill-color:transparent;">Desde<br/>2023</div>
    <div class="stat-small">Fundada para resolver<br/>o que outros terceirizam</div>
  </div>
  <div class="stat-item">
    <div class="stat-big" style="background:linear-gradient(135deg,#FF7A00,#E06800);-webkit-background-clip:text;-webkit-text-fill-color:transparent;">2 em 1</div>
  ...
  <div class="stat-item">
    <div class="stat-big" style="background:linear-gradient(135deg,#00C8E8,#0088CC);-webkit-background-clip:text;-webkit-text-fill-color:transparent;">&lt; 24h</div>
  ...
  <div class="stat-item">
    <div class="stat-big" style="background:linear-gradient(135deg,#FF7A00,#E06800);-webkit-background-clip:text;-webkit-text-fill-color:transparent;">100%</div>
...
<section class="services" id="servicos">
  ...
  <div class="svc-grid">
    ...
    <div class="svc-card">
      ...
      <div class="svc-problem" style="color:#FF7A00;">Máquina lenta ou sistema travando no pior momento?</div>
      ...
      <div class="svc-transform" style="border-color:#FF7A00;background:rgba(255,122,0,.07);color:#FF7A00;">→ Ambiente estável, menos paradas, mais desempenho</div>
      <div class="svc-tags">
...
<section class="projects" id="projetos">
  ...
  <div class="proj-grid" style="margin-top:48px;">
    <!-- Case 1 -->
    <div class="proj-card">
      <div class="proj-thumb" style="background:linear-gradient(135deg,#0A0E1A,#111827);">
      ...
      <div class="proj-body">
        <div class="proj-niche" style="background:rgba(0,200,232,.1);color:#00C8E8;">Software · ERP</div>
        <div class="proj-context"><strong style="color:#7A8BA8;">Problema:</strong> Gestão feita em planilhas compartilhadas. Dois vendedores vendendo o mesmo item sem saber.</div>
        <div class="proj-solution"><strong style="color:#7A8BA8;">Solução:</strong> Sistema web com controle de estoque em tempo real, emissão de pedidos, comissões e relatório gerencial.</div>
        <div class="proj-result" style="background:rgba(0,200,232,.07);border:1px solid rgba(0,200,232,.15);">
          <div>
            <div class="proj-result-num" style="color:#00C8E8;">+38%</div>
            <div class="proj-result-desc">produtividade operacional</div>
          </div>
          <div style="font-size:10px;color:#3D5068;">Primeiros 3 meses</div>
        </div>
      </div>
    </div>
    ...
    <!-- Case 2 -->
    <div class="proj-card">
      <div class="proj-thumb" style="background:linear-gradient(135deg,#111827,#1A2236);">
        <div style="position:absolute;top:16px;right:16px;font-size:28px;">💬</div>
        <div class="proj-client">E-commerce de moda · São Paulo</div>
        <div class="proj-title-sm">Bot de Atendimento WhatsApp + IA</div>
      </div>
      <div class="proj-body">
        <div class="proj-niche" style="background:rgba(255,122,0,.1);color:#FF7A00;">Automação · IA</div>
        <div class="proj-context"><strong style="color:#7A8BA8;">Problema:</strong> Equipe de 2 pessoas respondendo 800+ mensagens por dia. Clientes esperando horas por rastreio.</div>
        <div class="proj-solution"><strong style="color:#7A8BA8;">Solução:</strong> Bot com IA para rastreio, FAQ e qualificação de compra. Handoff para humano apenas nos casos complexos.</div>
        <div class="proj-result" style="background:rgba(255,122,0,.07);border:1px solid rgba(255,122,0,.15);">
          <div>
            <div class="proj-result-num" style="color:#FF7A00;">-70%</div>
            <div class="proj-result-desc">no tempo de resposta</div>
          </div>
          <div style="font-size:10px;color:#3D5068;">10k msgs processadas/dia</div>
        </div>
      </div>
    </div>
    ...
    <div class="proj-card">
      ...
      <div class="proj-body">
        <div class="proj-niche" style="background:rgba(0,200,232,.1);color:#00C8E8;">Hardware · IoT</div>
        <div class="proj-context"><strong style="color:#7A8BA8;">Problema:</strong> Variações de temperatura descobertas horas depois, resultando em perda de carga e multas sanitárias.</div>
        <div class="proj-solution"><strong style="color:#7A8BA8;">Solução:</strong> 32 sensores ESP32 com alertas em tempo real via Telegram e dashboard histórico de temperatura e umidade.</div>
        <div class="proj-result" style="background:rgba(0,200,232,.07);border:1px solid rgba(0,200,232,.15);">
          <div>
            <div class="proj-result-num" style="color:#00C8E8;">R$ 0</div>
            <div class="proj-result-desc">em perda de carga desde instalação</div>
          </div>
          <div style="font-size:10px;color:#3D5068;">98% uptime · 6 meses</div>
        </div>
      </div>
    </div>
  </div>
...
<section class="testimonials" id="depoimentos">
  ...
  <div class="test-grid">
    ...
    <div class="test-card" style="border-color:rgba(255,122,0,.15);">
      <div class="test-header">
        <div class="avatar-initials" aria-label="Ana Rodrigues" style="background:#FF7A00;">AR</div>
        <div class="test-meta">
...
<section class="cta-final" id="contato">
  ...
  <h2 class="cta-final-h2">
    ...
    <span style="background:linear-gradient(90deg,#FF7A00,#00C8E8);-webkit-background-clip:text;-webkit-text-fill-color:transparent;">tecnologia sem solução?</span>
  </h2>
...
<footer class="footer">
  <div class="footer-grid">
    <div>
      <div class="f-logo"><img src="/logo-oficial.png" alt="Código Base — Software & Hardware Solutions" /><span class="logo-wordmark"><span class="logo-codigo">CÓDIGO</span><span class="logo-dash">-</span><span class="logo-base">BASE</span></span></div>
