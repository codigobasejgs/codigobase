...
type AiSettings = { id: number; enabled: boolean; model: string; business_name: string; system_prompt: string; handoff_keywords: string[]; bot_detection_keywords: string[]; gemini_api_key?: string | null; };
...
export default function AdminApp() {
  ...
  async function loadAll() {
    ...
    setSettings(settingsRes.data ? { ...settingsRes.data, system_prompt: settingsRes.data.system_prompt || DEFAULT_PROMPT } : null);
